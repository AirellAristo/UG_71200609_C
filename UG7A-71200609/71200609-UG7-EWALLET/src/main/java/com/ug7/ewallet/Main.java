...
public class Main {
    public static void main(String[] args) {
        ...
        User U_71200609 = new User("Airell Aristo", "airell.aristo@ti.ukdw.ac.id", 30000);

        ShopeePay E_71190480 = new ShopeePay(U_71190480);
        GoPay E_71200609 = new GoPay(U_71200609);
        ...
        System.out.println("\n========== TOP UP #1 ==========");
        System.out.print("["+E_71200609.getUser().getNama()+"] - ");
        E_71200609.topup(10000);
        ...
        System.out.println("\n========== TOP UP #3 ==========");
        System.out.print("["+E_71200609.getUser().getNama()+"] - ");
        E_71200609.topup(50000);
        System.out.print("["+E_71200609.getUser().getNama()+"] - ");
        E_71200609.topup(9000);

        System.out.println("\n========== TRANSFER #1 ==========");
        System.out.print("["+E_71190480.getUser().getNama()+"] - ");
        E_71190480.transfer(E_71200609, 2500);
        ...
        System.out.println("\n========== TRANSER #3 ==========");
        System.out.print("["+E_71200609.getUser().getNama()+"] - ");
        E_71200609.transfer(E_71190480, 9500);

        System.out.println("\n========== WITHDRAW #1 ==========");
        System.out.print("["+E_71190480.getNama()+"] - ");
        E_71190480.withdraw(11000);
        System.out.print("["+E_71200609.getUser()+"] - ");
        E_71200609.withdraw(1100);
